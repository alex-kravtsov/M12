...
$appRole = 'none';
$usersRoles = array(
    'full' => array('role' => 'full', 'passwd' => 'vqAyKbw',),
    'beta' => array('role' => 'beta', 'passwd' => 'AuR2VHj',),
    'release' => array('role' => 'release', 'passwd' => 'mw0VBn',),
);
...
class VersionManager {
    ...
    static function get() {
        $result = array();
        $db_link = self::connect('localhost', 'u_updater', '123456', 'db_updater') or die(mysql_error());
        if (is_array($db_link)) {
